...
export const servicesDialogData = {
  ...
  privatarztlich: {
    ...
    treatmentInfo: {
      duration: "Je nach Behandlung",
      onset: "Sofort verfügbar",
      longevity: "Nach Bedarf",
      downtime: "Keine",
    },
    pricingGroups: [
      {
        ...
        items: [
          ...
          { name: "Wundversorgung", basePrice: "Nach GOÄ" },
          { name: "Beratungsgespräch", basePrice: "Nach GOÄ" },
          { name: "Weitere Leistungen", basePrice: "Nach GOÄ" },
        ],
      },
    ],
    disclaimers: [
